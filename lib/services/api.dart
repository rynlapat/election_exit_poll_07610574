...
import 'package:election_exit_poll_07610574/models/api_result.dart';
...
class Api {
  ...
  Future<dynamic> submit(
    ...
    final response = await http.post(
      url,
      headers: {'Content-Type': 'application/json','id':'07610574'},
  ...
  Future<dynamic> fetch(
    ...
    final response = await http.get(url,headers: {'id':'07610574'});
